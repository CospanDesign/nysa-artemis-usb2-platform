...
"""
wb_riffa_pcie_interface Driver
...
class wb_riffa_pcie_interfaceDriver(driver.Driver):

    """ wb_riffa_pcie_interface

        Communication with a DutDriver wb_riffa_pcie_interface Core
    """
    @staticmethod
    def get_abi_class():
        return 0
    ...
    def __init__(self, nysa, urn, debug = False):
        super(wb_riffa_pcie_interfaceDriver, self).__init__(nysa, urn, debug)
